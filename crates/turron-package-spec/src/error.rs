...
pub enum SpecErrorKind {
    ...
    #[diagnostic(code(turron::spec::invalid_semver_component))]
    Context(&'static str),

    #[error("Incomplete input to semver parser.")]
    #[diagnostic(code(turron::spec::incomplete_semver))]
    IncompleteInput,

    #[error("An unspecified error occurred.")]
    #[diagnostic(code(turron::spec::other))]
    Other,
}
